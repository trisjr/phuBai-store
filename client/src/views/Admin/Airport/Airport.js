...
function Airport() {
    ...
    const handleFind = () => {
        return find(airports, findState);
    };
                        ...
                        <div className={PageStyles.table}>
                            <div className={PageStyles.table__head}>
                                ...
                                <div
                                    ...
                                    onClick={() => handleSetSort("province")}
                                >
                                    <div className={Styles.text}>Province</div>
                                    <i className={PageStyles.icon}>
                                        {sortState.value === "province" ? (
                                            sortState.type === "asc" ? (
                                                <IoCaretDown
                                                    className={PageStyles.svg}
                                                />
    ...
    return (
        <div className={clsx(PageStyles.content, PageStyles[theme])}>
            <div className={PageStyles.title}>Airport</div>
            {body}
