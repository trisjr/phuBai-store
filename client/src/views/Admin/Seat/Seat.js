...
function Seat() {
                        ...
                        <div className={PageStyles.table}>
                            <div className={PageStyles.table__head}>
                                ...
                                <div
                                    ...
                                    onClick={() => handleSetSort("plane/code")}
                                >
                                ...
                                <div
                                    className={Styles.seatType}
                                    onClick={() =>
                                        handleSetSort("seatType/name")
                                    }
                                >
                                    <div className={Styles.text}>Seat Type</div>
                                    <i className={PageStyles.icon}>
                                        {sortState.value === "seatType/name" ? (
                                            sortState.type === "asc" ? (
                                                <IoCaretDown
                                                    className={PageStyles.svg}
                                                />
    ...
    return (
        <div className={clsx(PageStyles.content, PageStyles[theme])}>
            <div className={PageStyles.title}>Airline</div>
            {body}
